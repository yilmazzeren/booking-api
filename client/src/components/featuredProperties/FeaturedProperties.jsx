  ...
  return (
    <div className="w-full max-w-5xl flex justify-between gap-5">
      <div className="flex-1 gap-2 flex flex-col">
        ...
        />
        <span className="text-gray-400 font-bold">Aparthotel Stare Miasto</span>
      ...
      <div className="flex-1 gap-2 flex flex-col">
        <img
          ...
          className="w-full h-60 object-cover hover:scale-105 duration-200 hover:cursor-pointer"
        />
        <span className="text-gray-400 font-bold">Comfort Suites Airport</span>
      ...
      <div className="flex-1 gap-2 flex flex-col">
        <img
          ...
          className="w-full h-60 object-cover hover:scale-105 duration-200 hover:cursor-pointer"
        />
        <span className="text-gray-400 font-bold">Four Seasons Hotel</span>
      ...
      <div className="flex-1 gap-2 flex flex-col">
        <img
          ...
          className="w-full h-60 object-cover hover:scale-105 duration-200 hover:cursor-pointer"
        />
        <span className="text-gray-400 font-bold">Hilton Garden Inn</span>
